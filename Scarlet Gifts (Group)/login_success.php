...
// Put this code in first line of every web page.
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left" role="search" name="allsearch" action="search.php" onsubmit="return validateForm(search)" method="post">
        ...
        <button type="submit" class="btn btn-default">Submit</button>
  			...
  			<div class="row">
	  			<h2>Welcome To Scarlet Gifts!!</h2>
	  			
	  			<h4>Search for Gifts from our Vendors!</h4>
	  			
	  			<form class="" role="search" name="allsearch" action="search.php" onsubmit="return validateForm(search)" method="post">
	  			<div class="form-group">
          <input type="text" name="search" autofocus maxlength="100" class="form-control" placeholder="Search">
        </div>
        <button type="submit" class="btn btn-default">Submit</button>
