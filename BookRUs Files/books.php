...
<H2>Books R Us</h2>
		...
		?>
	<div class='col-xs-4 col-md-3' style='min-width:250px;min-height:200px;'>
	<a class="thumbnail" style='text-decoration:none;' href='reviews.php?id="<?php echo $row[0];?>"'>
      <img src="<?php echo $row[5];?>" alt="" class="img-rounded" height='30px' width='250' style='text-decoration:none;'>
  ...
  echo "Oops! Seems like we do not carry that particular book. Do not worry, you can search <a href='$ebay'>eBay</a> and <a href='$google'>Google</a> databases.";	?>
