...
<table width="500" border="1" cellspacing="0" cellpadding="0" bordercolor="#EEEEEE" align="center">
  <tr> 
    ...
    <td width="50"> <a href="#" onClick="window.open('https://www.paypal.com/cart/display=1&business=<?echo "$business"?>','cartwin','width=600,height=400,scrollbars,resizable,status');"><img src="images/b_viewcart.gif" border="0" width="74" height="21"></a> 
      <font face="Verdana, Arial, Helvetica, sans-serif"><b><font size="1"><a href="#" onClick="window.open('https://www.paypal.com/cart/add=1&business=<?echo "$business"?>&item_name=<? echo "$row->item_name"?>&item_number=<? echo "$row->item_id"?>&amount=<? echo "$row->item_price"?>&image_url=<? echo "$row->logo_location"?>&return=<? echo "$row->page_Success"?>&cancel_return=<? echo "$row->page_cancel"?>','cartwin','width=600,height=400,scrollbars,resizable,status');"><img src="images/b_addtocart.gif" border="0"></a></font></b></font></td>
  </tr>
</table>
<br>
