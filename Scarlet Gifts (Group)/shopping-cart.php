...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
	...
	<div class="row">
                    ...
                    <tr>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body pull-left">
                                ...
                                <h4 class="media-heading" style="text-decoration: none;"><a href="#"><?php echo $row[1] ?></a></h4>
                                <h5 class="media-heading" style="text-decoration: none;"> by <a href="#"><?php echo $row[3] ?></a></h5>
		...
		<strong>
			<?php echo $currency,$row[2];
			$sumTotal = $sumTotal + $row[2];
			?>
		</strong>
		</td> 
                    ...
                    <tr>
                        ...
                        <td>   </td>
                        <td><h3>Total</h3></td>
                        <td class="text-right"><h3><strong><?php echo $currency,$sumTotal; ?></strong></h3></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                        <td>   </td>
                        <td>
                        <button type="button" class="btn btn-default"><a style="text-decoration: none; color: black;" href="search.php">
                        ...
                        <td>
							...
							<input type="hidden" name="item_name" value="<?php echo "Payment to Scarlet Gifts"; ?>">
