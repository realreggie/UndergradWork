...
<li class="active"><a href="index1.php">Home</a></li>
	...
	<a class="thumbnail" height='200' style='text-decoration:none;'>
      <img src="<?php echo $row[5];?>" alt="" class="img-rounded" height='100' width='250' style='text-decoration:none;'>
        ...
        <p><?php echo $row[2]; ?></p>
       <a href='add-to-cart.php?action=add&id="<?php echo $row[0]?>"'><button class='btn btn-sm btn-danger' style='font-size:1em; margin:.5em 0 .5em 0;'><span class='glyphicon glyphicon-shopping-cart '>Add to Cart</button></span></a> 
           </a> 
		 </div>
		 <?php } // end of loop ?> 
		</div>
