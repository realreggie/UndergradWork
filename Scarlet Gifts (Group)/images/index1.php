...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="item active">
      <img src="http://studentweb.comminfo.rutgers.edu/class-2014-9-04-547-410-01/group3/images/StuffYerFace.jpg" alt="...">
    ...
    <div class="item">
      <img src="http://studentweb.comminfo.rutgers.edu/class-2014-9-04-547-410-01/group3/images/starbucks.jpg" alt="...">
      <div class="carousel-caption">
        What
      </div>
    </div>
      ...
      <div class="item">
      <img src="http://studentweb.comminfo.rutgers.edu/class-2014-9-04-547-410-01/group3/images/NatGeo15.jpg" alt="...">
      <div class="carousel-caption">
        What
      </div>
    </div>
 ...
 <hr class="featurette-divider"><!-- Third Section-->
      ...
      <div class="row featurette">
        ...
        <div class="col-md-7">
          ...
          <p class="lead">We partner with stores predominantly located in the New Brunswick area, more specifically in and around the 4 campuses. Our partners are Bravo, Brother Jimmys, Chipotle, Duncan Donut, Qdoba, Starbucks, Shoprite, Stuff Yer Face, Target, Walmart and Wine Country. Our offer may not be eligible to these same stores outside of a 5 mile radius of the college campuses.</p>
        </div>
