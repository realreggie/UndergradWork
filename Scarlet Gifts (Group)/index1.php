...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="index1.php">Home</a></li>
          ...
          <ul class="dropdown-menu" role="menu">
			...
			<li id="jimmy"><a href="descriptions.php?id=3" class="link">Brother Jimmy's</a></li>
      ...
      <ul class="nav navbar-nav">
      <li><a href="shopping-cart.php"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>Shopping Cart </a></li>      </ul>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
      ...
      <img src="http://studentweb.comminfo.rutgers.edu/class-2014-9-04-547-410-01/group3/images/Rutgers-Clock-New-Brunswick.jpg" alt="..." height = "100%" width = "100%">
    ...
    <div class="item ">
      <img src="http://studentweb.comminfo.rutgers.edu/class-2014-9-04-547-410-01/group3/images/campuslife-bus-students.jpg" alt="..." height = "100%" width = "100%">
      <div class="carousel-caption">
        </div>
    </div>
 ...
 <hr class="featurette-divider"> <!-- Second Section-->
      ...
      <div class="row featurette">
        <div class="col-md-7">
          ...
          <p class="lead">Scarlet Gifts is an organization dedicated to providing the Rutgers Community with the opportunity to utilize their affiliate privileges to purchase Gift Certificates at a discount for their favorite stores. We seek to establish a connection between Students, Faculty, Staff and the stores they frequently visit. We partner with the select stores and pass the savings onto the Rutgers Community.</p>
        </div>
        <div class="col-md-5">
